...
class Booking_put:
    ...
    def to_dict(self):
        ...
        string_to_convert = "{"
        if (parameters[0] != "" and parameters[0] != None) or (
                parameters[1] != "" and parameters[1] != None):
        ...
        if parameters[3] != "" and parameters[3] != None:
            ...
            string_to_convert += "}, "
        if (parameters[4] != "" and parameters[4] != None) or (
                parameters[5] != "" and parameters[5] != None) or (
